...
const siteLogo = SITE_LOGO || SITE_TITLE || "Blog";
...
export default defineConfig({
  ...
  env: {
    schema: {
      ...
      // Giscus (static comments backed by GitHub Discussions)
      GISCUS_REPO: EnvStr(),
      GISCUS_REPO_ID: EnvStr(),
      GISCUS_CATEGORY: EnvStr(),
      GISCUS_CATEGORY_ID: EnvStr(),
    },
  },
  ...
  integrations: [
    sitemap(),
    typst({
      // Always render Typst as semantic HTML so it can be embedded in pages.
      target: "html",
      htmlMode: "body",
    }),
    tylant({
